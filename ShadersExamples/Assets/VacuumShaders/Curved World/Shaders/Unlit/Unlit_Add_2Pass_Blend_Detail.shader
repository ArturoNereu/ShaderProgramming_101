...
Shader "Hidden/VacuumShaders/Curved World/Unlit/Additive (2 Pass)/Detail"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       ...
		       "CurvedWorldTag"="Unlit/Additive (2 Pass)/Detail" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Additive/Detail/BASE"
