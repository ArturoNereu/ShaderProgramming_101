...
Shader "Hidden/VacuumShaders/Curved World/Unlit/Transparent (2 Pass)/Decal"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       ...
		       "CurvedWorldTag"="Unlit/Transparent (2 Pass)/Decal" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Transparent/Decal/BASE"
