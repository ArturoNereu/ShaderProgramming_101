...
Shader "Hidden/VacuumShaders/Curved World/Unlit/Transparent (2 Pass)/Texture"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
			   ...
			   "CurvedWorldTag"="Unlit/Transparent (2 Pass)/Texture" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Transparent/Texture/BASE"
