...
Shader "Hidden/VacuumShaders/Curved World/Unlit/Transparent (2 Pass)/Vertex Alpha"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       ...
		       "CurvedWorldTag"="Unlit/Transparent (2 Pass)/Vertex Alpha" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Transparent/Vertex Alpha/BASE"
