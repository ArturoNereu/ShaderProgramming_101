...
Shader "Hidden/VacuumShaders/Curved World/Unlit/Additive (2 Pass)/Texture"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
			   ...
			   "CurvedWorldTag"="Unlit/Additive (2 Pass)/Texture" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Additive/Texture/BASE"
