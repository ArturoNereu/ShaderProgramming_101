...
Shader "Hidden/VacuumShaders/Curved World/Unlit/Additive (2 Pass)/Decal"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       ...
		       "CurvedWorldTag"="Unlit/Additive (2 Pass)/Decal" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/Unlit/Additive/Decal/BASE"
