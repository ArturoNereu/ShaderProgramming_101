...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent (2 Pass)/Detail"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="One Directional Light/Transparent (2 Pass)/Detail" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent/Detail/FORWARD"
