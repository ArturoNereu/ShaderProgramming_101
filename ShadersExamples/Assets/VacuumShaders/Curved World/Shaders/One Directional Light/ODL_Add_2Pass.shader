...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Additive (2 Pass)/Texture"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="One Directional Light/Additive (2 Pass)/Texture" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/One Directional Light/Additive/Texture/FORWARD"
