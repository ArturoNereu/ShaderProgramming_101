...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent (2 Pass)/Vertex Alpha"
{
	Properties    
	{               
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="One Directional Light/Transparent (2 Pass)/Vertex Alpha" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent/Vertex Alpha/FORWARD"
