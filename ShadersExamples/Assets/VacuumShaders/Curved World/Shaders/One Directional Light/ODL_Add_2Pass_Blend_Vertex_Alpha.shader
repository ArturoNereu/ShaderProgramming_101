...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Additive (2 Pass)/Vertex Alpha"
{
	Properties    
	{               
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="One Directional Light/Additive (2 Pass)/Vertex Alpha" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/One Directional Light/Additive/Vertex Alpha/FORWARD"
