...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Additive (2 Pass)/Detail"
{
	Properties 
	{
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
		       ...
		       "CurvedWorldTag"="One Directional Light/Additive (2 Pass)/Detail" 
		...
		//Base
		UsePass "Hidden/VacuumShaders/Curved World/One Directional Light/Additive/Detail/FORWARD"
